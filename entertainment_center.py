...
what_we_do_in_the_shadows = media.Movie("What We Do in the Shadows",
                                        """Viago, Deacon, and Vladislav are vampires who are finding that modern life has
                                        them struggling with the mundane - like paying rent, keeping up with the chore wheel,
                                        trying to get into nightclubs, and overcoming flatmate conflicts.""",
...
the_fountain = media.Movie("The Fountain",
                           """As a modern-day scientist, Tommy is struggling with mortality, desperately searching for
                           the medical breakthrough that will save the life of his cancer-stricken wife, Izzi.""",
...
berlin_blues = media.Movie("Berlin Blues",
                           """Frank Lehmann (Christian Ulmen) is a bartender working in Kreuzberg, a borough of
                           West Berlin in October 1989, in the final weeks before the fall of the Berlin Wall.
                           As he is approaching his 30th birthday, his friends start teasing him by calling him "Herr Lehmann" ("Mr. Lehmann").
                           He has little interest in anything outside of SO 36, the eastern part of the borough of Kreuzberg.
                           He has a brief relationship with Katrin (Katja Danowski (de)), a cook at a nearby bar.
                           His best friend, Karl (Detlev Buck) slowly goes mad, and his parents show up for a visit, disrupting his laid-back lifestyle.""",
                           "http://www.wagnerverein-jena.de/wp-content/uploads/2015/04/herr-lehmann.jpg",
